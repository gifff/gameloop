...
#ifdef __APPLE__
    //    ref: https://learnopengl.com/code_viewer_gh.php?code=src/1.getting_started/1.2.hello_window_clear/hello_window_clear.cpp
...
GLuint Engine::Game::BuildShader(const char* vertexPath, const char* fragmentPath, const char* geometryPath)
{
    ...
    // check version
    std::cout << "MyOPENGLVersion is : " << glGetString(GL_VERSION) << std::endl;
    std::cout << "MyGLSLVersion is : " << glGetString(GL_SHADING_LANGUAGE_VERSION) << std::endl;
